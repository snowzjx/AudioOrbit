...
- [x] Safari tab tear-off and dragged playing tabs follow the media indicator to the destination window, including tearing a tab into a new window on another display.
